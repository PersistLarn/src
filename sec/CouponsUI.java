...
public class CouponsUI extends JPanel{
	public CouponsUI() {
		
	}

	Component initCouponsTab(){
	...
	Component createList1()
	  {
		DefaultMutableTreeNode couponsMainNode = new
			      DefaultMutableTreeNode("Couponing");
		
		DefaultMutableTreeNode addCoupons = new
			      DefaultMutableTreeNode("Add new coupons");
		
		DefaultMutableTreeNode reports = new
			      DefaultMutableTreeNode("Reports");
		
		DefaultMutableTreeNode oopReport = new
			      DefaultMutableTreeNode("On OOP");	
		
		DefaultMutableTreeNode bestDealReport = new
			      DefaultMutableTreeNode("Best deals");
		
		
		reports.add(oopReport);
		reports.add(bestDealReport);
		
		couponsMainNode.add(addCoupons);
		couponsMainNode.add(reports);		
		
		JTree tree = new JTree(couponsMainNode);
